...
const FlowMessageButtons = ({ message }: FlowMessageProps) => {
  return (
    <div className="customer-service message">
      ...
      <div>
        <small className="customer-employee-name text-muted">{"البوت"}</small>

        <div className="message-text">
          <p className="mb-2">{message.content}</p>

          <div className="d-flex align-item-center gap-2 mb-2">
            {message.buttons?.map((x, index) => (
              <button
...
export default FlowMessageButtons;
